...
// 半角数字チェック
public class HalfNumberChecks extends S2FieldChecks implements JsValidChecks {

    private static final long serialVersionUID = 1L;

    private static Logger logger = Logger.getLogger(HalfNumberChecks.class);

    public static boolean validateHalfNumber(Object bean,
        ...
        // 半角数字でない場合はエラー
        if (CheckError.halfNumber(strValue)) {
            addError(errors, field, validator, validatorAction, request);
            return false;
        }
    ...
    public String getJsErrMsg(Annotation annotation, String fieldName) {
        HalfNumber v = (HalfNumber)annotation;
