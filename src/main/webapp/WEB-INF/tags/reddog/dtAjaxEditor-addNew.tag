 ...
 *
 *   @param formId  新規作成ダイアログ内のformのidを指定する。必須。
...
<%-- ---------------------------------------------------------- --%>
<html:hidden property="ajaxEditorKeyId" styleId="hid-addNew-keyId"/>
